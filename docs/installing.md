...
- `deco-v1.0.0-alpha.4-x86_64-unknown-linux-gnu.tar.gz`
- `deco-v1.0.0-alpha.4-aarch64-unknown-linux-musl.tar.gz`
- `deco-v1.0.0-alpha.4-x86_64-pc-windows-msvc.zip`
- `deco-v1.0.0-alpha.4-x86_64-apple-darwin.tar.gz`
- `deco-v1.0.0-alpha.4-aarch64-apple-darwin.tar.gz`
- `deco-v1.0.0-alpha.4-x86_64-unknown-freebsd.tar.gz`
...
./deco-v1.0.0-alpha.4-<target>/deco --version
```
...
.\deco-v1.0.0-alpha.4-x86_64-pc-windows-msvc\deco.exe --version
```
